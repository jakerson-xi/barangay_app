...
<div class="content">
    ...
    @if($admin->role == 'Request Manager' || $admin->role == 'Barangay Secretary' )
    <div class="card text-center mb-3 ">
        <div class="card-header">
            <div class="d-sm-flex justify-content-between align-items-center ">
                <h3 class="text-dark mb-0">REQUESTED DOCUMENT REPORT</h3>
                <select id="report_select" class="form-select w-25" aria-label="Default select example">
                    <option selected value="re_report_all">Overall report</option>
                    <option value="re_report_assign">My report</option>
                </select>
            </div>
        </div>
        <div class="card-body">
            ...
            <div id="re_report_assign_div" style="display:none">
                <div class=" btn-group mb-3" role="group" aria-label="Basic radio toggle button group">
    ...
    @endif
    @if($admin->role == 'Concern Manager' || $admin->role == 'Barangay Secretary' )
    <div class="card text-center mb-3 ">
        <div class="card-header">
            <div class="d-sm-flex justify-content-between align-items-center ">
